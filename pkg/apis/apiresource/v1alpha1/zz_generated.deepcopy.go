...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NegociatedAPIResource) DeepCopyInto(out *NegociatedAPIResource) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NegociatedAPIResource.
func (in *NegociatedAPIResource) DeepCopy() *NegociatedAPIResource {
	if in == nil {
		return nil
	}
	out := new(NegociatedAPIResource)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NegociatedAPIResource) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NegociatedAPIResourceCondition) DeepCopyInto(out *NegociatedAPIResourceCondition) {
	*out = *in
	in.LastTransitionTime.DeepCopyInto(&out.LastTransitionTime)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NegociatedAPIResourceCondition.
func (in *NegociatedAPIResourceCondition) DeepCopy() *NegociatedAPIResourceCondition {
	if in == nil {
		return nil
	}
	out := new(NegociatedAPIResourceCondition)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NegociatedAPIResourceList) DeepCopyInto(out *NegociatedAPIResourceList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]NegociatedAPIResource, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NegociatedAPIResourceList.
func (in *NegociatedAPIResourceList) DeepCopy() *NegociatedAPIResourceList {
	if in == nil {
		return nil
	}
	out := new(NegociatedAPIResourceList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NegociatedAPIResourceList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NegociatedAPIResourceSpec) DeepCopyInto(out *NegociatedAPIResourceSpec) {
	*out = *in
	in.CommonAPIResourceSpec.DeepCopyInto(&out.CommonAPIResourceSpec)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NegociatedAPIResourceSpec.
func (in *NegociatedAPIResourceSpec) DeepCopy() *NegociatedAPIResourceSpec {
	if in == nil {
		return nil
	}
	out := new(NegociatedAPIResourceSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NegociatedAPIResourceStatus) DeepCopyInto(out *NegociatedAPIResourceStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]NegociatedAPIResourceCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NegociatedAPIResourceStatus.
func (in *NegociatedAPIResourceStatus) DeepCopy() *NegociatedAPIResourceStatus {
	if in == nil {
		return nil
	}
	out := new(NegociatedAPIResourceStatus)
	in.DeepCopyInto(out)
	return out
}
